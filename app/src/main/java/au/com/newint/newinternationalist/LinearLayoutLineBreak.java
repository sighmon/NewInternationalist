...
public class LinearLayoutLineBreak extends ViewGroup {

    private int line_height;

    public LinearLayoutLineBreak(Context context) {
        super(context);
    }

    public LinearLayoutLineBreak(Context context, AttributeSet attrs){
        super(context, attrs);
    }
